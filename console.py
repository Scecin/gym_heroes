...
member_1 = Member('Anna', 'Mackenzie', 'Standard', 'Activate')
...
gym_class_1 = Gym_class('Cycling', 'David', 45, 10, 'off-Peak hours', 'Activate')
gym_class_repository.save(gym_class_1)
gym_class_2 = Gym_class('Yoga', 'Juy', 60, 18, 'off-Peak hours', 'Activate')
gym_class_repository.save(gym_class_2)
gym_class_3 = Gym_class('Boxing', 'Kate', 45, 6, 'off-Peak hours', 'Activate')
